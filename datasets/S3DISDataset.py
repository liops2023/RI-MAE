...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='data/s3dis/stanford_indoor3d', num_point=4096, test_area=5, block_size=1.0, sample_rate=1.0, transform=None):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        return current_points, torch.zeros((1, 1)), current_labels, torch.zeros((1, 1))
...
class ScannetDatasetWholeScene():
    ...
    def __init__(self, root='data/s3dis/stanford_indoor3d', block_points=4096, split='test', test_area=5, stride=0.5, block_size=1.0, padding=0.001):
